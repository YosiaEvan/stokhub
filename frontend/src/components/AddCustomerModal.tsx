...
export default function AddCustomerModal({ setIsOpenModalAdd, setRefreshKey }: AddCustomerModalProps) {
                ...
                <div className="p-5 flex-1 overflow-y-auto">
                    <form onSubmit={handleAddCustomerSubmit}>
                        ...
                        <div className="flex items-center justify-end w-full">
                            <button type="submit" className="bg-green-500 hover:bg-green-700 text-white px-3 py-2 border border-green-500 rounded transition-all duration-300 mr-2">Add Customer</button>
